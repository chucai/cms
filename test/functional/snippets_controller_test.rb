...
class SnippetsControllerTest < ActionController::TestCase
  ...
  test "should create snippet" do
    assert_difference('Snippet.count') do
      post :create, snippet: { context: @snippet.context, description: @snippet.description, name: @snippet.name, stype: @snippet.stype }
    end
  ...
  test "should update snippet" do
    put :update, id: @snippet, snippet: { context: @snippet.context, description: @snippet.description, name: @snippet.name, stype: @snippet.stype }
    assert_redirected_to snippet_path(assigns(:snippet))
  end
